...
namespace GhFunctionApp.Webhooks.Factories;
...
public class GitHubClientFactory
{
    ...
    {
        var applicationName = configuration.GetSection("GitHub_ApplicationName").Value;
    ...
    {
        var apiUrl = _configuration.GetSection($"GitHub_{organization}_ApiUrl").Value;

        if (string.IsNullOrWhiteSpace(apiUrl)) apiUrl = "https://api.github.com";

        var applicationId = _configuration.GetSection($"GitHub_{organization}_ApplicationId").Value;
        ...
        var pemFilePath = _configuration.GetSection($"GitHub_{organization}_PrivateKeyFilePath").Value;
